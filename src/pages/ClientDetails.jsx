...
// ==========================================
// 1. ESTILOS CSS - MODO SCROLL GLOBAL
// ==========================================
const STYLES = `
    /* --- CONFIGURACIÓN PARA SCROLL GLOBAL --- */
    .page-scroll-wrapper {
        /* Importante: NO limitar la altura a 100vh */
        height: auto;              
        min-height: 100vh;         
        width: 100%;
        
        /* Dejar overflow visible para que el BODY del navegador tome el control */
        overflow: visible;         
...
return (
    <SidebarLayout>
        ...
        {/* ENVOLTORIO FLEXIBLE PARA SCROLL GLOBAL */}
        <div className="page-scroll-wrapper">
            
            {/* CAJA DE RELLENO INTERNO */}
            <div className="content-padding-box">
                ...
                <div className="header-container">
                    ...
                    <div className="header-actions">
                        ...
                        <button onClick={() => setModals(p => ({...p, createGroup: true}))} className="btn-secondary">
                            <FolderPlus size={18}/> Grupo
                        </button>
                        <button onClick={addRow} className="btn-secondary" disabled={!isEditMode}>
                            <Layers size={18}/> Fila
                        </button>
                        <button onClick={() => setModals(p => ({...p, createScreen: true}))} className="btn-primary">
                            <Plus size={18}/> Pantalla
                        </button>
                    </div>
                </div>
        ...
        {/* LOS MODALES VAN FUERA DEL SCROLL PARA EVITAR CONFLICTOS */}
